<html>
	<head>
		<meta charset="utf-8">
        <title>FindTweet | Connexion</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Connexion à FindTweet">
	...
	<body>	
		...
		<div class="col-xs-12 col-sm-6 col-sm-offset-1">
			...
			<p class="credits">Vous n'avez pas de compte ? <a href="register.php" target="_blank">Enregistrez-vous</a>.</p>
